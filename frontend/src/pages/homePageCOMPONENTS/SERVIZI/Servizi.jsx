...
const Servizi = () => {
  ...
  return (
    <div className="p-8 bg-gray-100 md:-mt-14">
      <head>
      ...
      <main className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {CategoriaDiServizi.map((categoria) => {
          ...
          const isLoaded = loadedImages[categoria.name]; // Verifica se l'immagine è caricata
          ...
          return (
            ...
            >
              ...
              >
                ...
                <img
                  src={isLoaded ? imageSrc : ImageNotFound}
                  className="w-full h-auto mb-4 rounded"
                  onLoad={() => handleImageLoad(categoria.name)}
                />
              </Link>
