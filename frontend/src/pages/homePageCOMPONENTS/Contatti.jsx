  ...
  return (
    <>
      <Helmet>
        ...
        <title>Contatti - Bracciano Nuova CdQ</title>
        <meta name="description" content="Browse through out Contatti" />
      </Helmet>
      <section className="bg-gradient-to-r from-gray-50 to-gray-100 py-20">
        <div className="container mx-auto px-6 lg:px-16 mb-12">
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600">
              La nostra missione è rendere Bracciano un luogo migliore per
              tutti.
            </p>
          </div>
        </div>
